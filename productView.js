...
let prodDetailsArr = [];
prodDetailsArr.push(JSON.parse(localStorage.getItem("product-list")));
...
function displayProd(prodDetailsArr){
    ...
    prodDetailsArr.forEach(function(ele,i){
        ...
        img1.setAttribute("src", ele.Image1)
        ...
        img2.setAttribute("src", ele.Image2)
        img2.addEventListener("click", function(){
            let image = document.createElement("img")
            image.setAttribute("src", ele.Image2)
        })
